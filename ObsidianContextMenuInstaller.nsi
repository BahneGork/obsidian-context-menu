...
Section "Install"
  ...
  FileWrite $0 ')$\r$\n'
  FileWrite $0 '$\r$\n'
  FileWrite $0 ':: If we closed Obsidian and had open vaults, create background script to reopen them$\r$\n'
  FileWrite $0 'if defined OPEN_VAULTS ($\r$\n'
  FileWrite $0 '    :: Create temporary script to handle delayed vault reopening$\r$\n'
  FileWrite $0 '    set "REOPEN_SCRIPT=%TEMP%\reopen_vaults_!VAULT_ID!.bat"$\r$\n'
  FileWrite $0 '$\r$\n'
  FileWrite $0 '    echo @echo off ^> "!REOPEN_SCRIPT!"$\r$\n'
  FileWrite $0 '    echo timeout /T 3 /NOBREAK ^^^>NUL ^>^> "!REOPEN_SCRIPT!"$\r$\n'
  FileWrite $0 '$\r$\n'
  FileWrite $0 '    :: Replace commas with spaces$\r$\n'
  FileWrite $0 '    set "VAULT_LIST=!OPEN_VAULTS:,= !"$\r$\n'
  FileWrite $0 '$\r$\n'
  FileWrite $0 '    :: Add vault open commands$\r$\n'
  FileWrite $0 '    for %%v in (!VAULT_LIST!) do ($\r$\n'
  FileWrite $0 '        if defined OBSIDIAN_EXE ($\r$\n'
  FileWrite $0 '            echo start "" "!OBSIDIAN_EXE!" "obsidian://open?vault=%%v" ^>^> "!REOPEN_SCRIPT!"$\r$\n'
  FileWrite $0 '        ) else ($\r$\n'
  FileWrite $0 '            echo start "" "obsidian://open?vault=%%v" ^>^> "!REOPEN_SCRIPT!"$\r$\n'
  FileWrite $0 '        )$\r$\n'
  FileWrite $0 '        echo timeout /T 1 /NOBREAK ^^^>NUL ^>^> "!REOPEN_SCRIPT!"$\r$\n'
  FileWrite $0 '    )$\r$\n'
  FileWrite $0 '$\r$\n'
  FileWrite $0 '    :: Script deletes itself when done$\r$\n'
  FileWrite $0 '    echo del "%%~f0" ^>^> "!REOPEN_SCRIPT!"$\r$\n'
  FileWrite $0 '$\r$\n'
  FileWrite $0 '    :: Start background script and exit immediately$\r$\n'
  FileWrite $0 '    start "" cmd /c "!REOPEN_SCRIPT!"$\r$\n'
  FileWrite $0 ')$\r$\n'
  FileWrite $0 "$\r$\n"
