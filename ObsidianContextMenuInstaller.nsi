...
Section "Install"
  ...
  FileWrite $0 '    echo Open vaults: !OPEN_VAULTS!$\r$\n'
  FileWrite $0 '    timeout /T 3 /NOBREAK >NUL$\r$\n'
  FileWrite $0 '$\r$\n'
  FileWrite $0 '    :: Replace commas with spaces for iteration$\r$\n'
  FileWrite $0 '    set "VAULT_LIST=!OPEN_VAULTS:,= !"$\r$\n'
  FileWrite $0 '$\r$\n'
  FileWrite $0 '    :: Parse vault IDs and open each one$\r$\n'
  FileWrite $0 '    for %%v in (!VAULT_LIST!) do ($\r$\n'
  FileWrite $0 '        echo Opening vault: %%v$\r$\n'
  FileWrite $0 '        if defined OBSIDIAN_EXE ($\r$\n'
